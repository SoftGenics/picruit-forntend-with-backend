...
<div class="register-photo">
		...
		<div class="or-seperator"><b>or</b></div>
                ...
                <div class="form-group"><button class="btn btn-success btn-block" type="submit">Sign Up</button></div><a href="login" class="already" style="color:green;">You already have an account? Login here.</a></form>
        </div>
    </div>
@stop